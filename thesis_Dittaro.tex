...
Inoltre per la maggior parte dei temi è possibile provare una demo che permette la visualizzazione dell'aspetto generale e la navigazione nelle varie sezioni in modo da poterne analizzare la struttura. Sono poi generalamente presenti la documentazione del tema stesso, le specifiche per scaricarlo, il collegamento alla repository di GitHub
