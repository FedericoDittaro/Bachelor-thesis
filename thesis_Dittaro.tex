...
\end{enumerate}
La procedura di aggiornamento è visibile nella sezione \textit{Actions} della propria repository. Le voci "pages build and deployment" inizialmente avranno un simbolo giallo a simboleggiare lo svolgimento dell'operazione, 
...
\begin{itemize}
    ...
    Proprio quest'ultimo costrutto viene subito utilizzato per verificare la presenza di un'immagine nel front-matter del corrispondente file markdown, in caso positivo viene posizionata la foto specificata altrimenti un'immagine di default. 
...
L'implementazione di questa funzionalità è stata svolta all'interno del file \textbf{form.html} nella cartella \textit{themes/tella/layouts/shortcodes}, il codice mostrato in \cref{img:form}, attraverso il comando "action", permette di importare questa funzionalità definendo successivamente i campi desiderati.
